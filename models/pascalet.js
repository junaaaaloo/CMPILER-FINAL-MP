...
rules: [/^(?:;)/,/^(?:\s+)/,/^(?:program\b)/,/^(?:var\b)/,/^(?:begin\b)/,/^(?:end\b)/,/^(?:if\b)/,/^(?:of\b)/,/^(?:then\b)/,/^(?:else\b)/,/^(?:while\b)/,/^(?:do\b)/,/^(?:to\b)/,/^(?:for\b)/,/^(?:while\b)/,/^(?:repeat\b)/,/^(?:until\b)/,/^(?:function\b)/,/^(?:procedure\b)/,/^(?:const\b)/,/^(?:array\b)/,/^(?:\{)/,/^(?:\})/,/^(?:#)/,/^(?:\?)/,/^(?::=)/,/^(?:\()/,/^(?:\))/,/^(?:\[)/,/^(?:\])/,/^(?:\*)/,/^(?:\/)/,/^(?:%)/,/^(?:\+)/,/^(?:-)/,/^(?:<=)/,/^(?:<>)/,/^(?:<)/,/^(?:>=)/,/^(?:>)/,/^(?:=)/,/^(?:,)/,/^(?::)/,/^(?:\.)/,/^(?:mod\b)/,/^(?:div\b)/,/^(?:and\b)/,/^(?:or\b)/,/^(?:not\b)/,/^(?:$)/,/^(?:[\+\-]?\d+\.\d+)/,/^(?:[\+\-]?\d+)/,/^(?:true|false\b)/,/^(?:'.')/,/^(?:'(\\.|[^'\\])*')/,/^(?:char|integer|boolean|string|real\b)/,/^(?:[$a-zA-Z_]+[A-Za-z0-9_]*)/,/^(?:$)/],
